  ...
  <div>
            ...
            <el-table-column label="操作">
              <template slot-scope="scope">
                ...
                <el-button size="mini" type="danger" icon="el-icon-delete"
                  @click="deleteParamsForm(scope.row.attr_id)">
                  删除</el-button>
              </template>
            </el-table-column>
          </el-table>
        ...
        <el-tab-pane label="静态属性" name="only">
          ...
          <el-table :data="onlyTableData" border stripe>
            <el-table-column type="expand">
              <template slot-scope="scope">
                <el-tag closable v-for="(item, i) in scope.row.attr_vals"
                  @close="handleClose(i, scope.row)" :key="i">
                  {{item}}</el-tag>
              </template>
            </el-table-column>
            <el-table-column type="index" label="#">
    ...
    <el-dialog :title="'添加' + titleText" :visible.sync="addDialogVisible"
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="addDialogVisible = false">取
          消
        </el-button>
    ...
    <el-dialog :title="'修改' + titleText" :visible.sync="editDialogVisible"
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="editParams">确 定
        </el-button>
      </span>
    </el-dialog>
  </div>
